...
#define MSM_VOLUME_STEP ((MSM_MAX_VOLUME+27)/150) /* 17 added to avoid more deviation */
#else
#define MSM_MAX_VOLUME 0x2000
#define MSM_VOLUME_STEP ((MSM_MAX_VOLUME+17)/100) /* 17 added to avoid more deviation */
#endif
